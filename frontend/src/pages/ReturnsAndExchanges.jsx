    ...
    <div className="container mx-auto my-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-800">
          At SellEase Store, we want you to be satisfied with your purchase. If you are not completely
      ...
      <div>
        ...
        <p className="text-gray-800">
          ...
          contact our customer support team at support@example.com or call us at +9231283934.
        </p>
      </div>
    </div>
  );
